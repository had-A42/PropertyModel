...
public:
  Application() {
    ...
    b.AddMethod<Templates::Out<0>, Templates::Data<0>, Templates::Value<0>>(
        f1_1);
    b.AddMethod<Templates::Data<0>, Templates::Out<0>, Templates::Value<0>>(
        f1_2);
    b.AddMethod<Templates::Value<0>, Templates::Out<0>, Templates::Data<0>>(
        f1_2);

    b.AddNewConstraint(Priority::Strength{2});
    b.AddMethod<Templates::Value<1>, Templates::Data<0>, Templates::Data<1>>(
        f2);

    b.AddNewConstraint(Priority::Strength{3});
    b.AddMethod<Templates::Value<2>, Templates::Data<1>, Templates::Data<2>>(
        f3);
